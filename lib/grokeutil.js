...
/**
 * converts "moduleA/moduleB/func" to ["moduleA/moduleB", "func"]
 */
exports.uri2modAndFunc = function (uri) {
    var funcname, uriparts = uri.split("/");
    funcname = uriparts.pop();
    return [uriparts.join("/"), funcname];
};
