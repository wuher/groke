    ...
    methodist(
        {
            post: catchall(
                rpc(
                    function (req, uri, params) {
                        return rpchandlers.executeObjectFunction(uri, params);
                    }))
        });
 ...
 */
map[uriPrefixes.functions] =
    methodist(
        {
            post: catchall(
                rpc(
                    function (req, uri, params) {
                        return rpchandlers.executeAnonymousFunction(uri, params);
                    }))
        });
 ...
 */
map[uriPrefixes.ctors] =
    methodist(
        {
            post: catchall(
                rpc(
                    function (req, uri, params) {
                        return rpchandlers.executeConstructor(uri, params);
                    }))
        });
